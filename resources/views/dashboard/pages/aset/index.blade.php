                        ...
                        <tbody>
                            @foreach ($assets as $aset)
                                <tr>
                                    ...
                                    <td>{{ number_format($aset->harga, 0, ',', '.') }}</td>
                                    <td>{{ $aset->alamat }}</td>
                                    <td>{{ $aset->kabupaten }}</td>
                                    <td>{{ $aset->jangka_sewa }}</td>
                                    <td>{{ $aset->lokasi }}</td>
                                    <td>
                                        <a href="{{ route('foto_asset.show', $aset->id) }}" class="btn btn-sm btn-info">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('aset.update', $aset->id) }}" method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="jangka_sewa" class="form-label">Jangka Sewa</label>
                                                        <input type="text"
                                                            class="form-control @error('jangka_sewa') is-invalid @enderror"
                                                            name="jangka_sewa" id="jangka_sewa"
                                                            value="{{ old('jangka_sewa', $aset->jangka_sewa) }}" required>
                                                        @error('jangka_sewa')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
